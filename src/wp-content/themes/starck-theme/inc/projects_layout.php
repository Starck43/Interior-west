...
function register_projects_post_type_and_taxonomy() {
	...
	$labels = array(
		...
		'add_new_item' => __('Add','Project','starck'),
		'edit_item' => __('Edit','Project','starck'),
		'new_item' => __('New','Project','starck'),
		'all_items' => __('All Projects','starck'),
		'view_item' => __('View','Project','starck'),
		'update_item' => __('Update','Project','starck'),
		'search_items' => __('Search','Project','starck'),
