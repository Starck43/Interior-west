...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Starck_Customize_Width_Slider_Control' ) ) {
	/**
	 * Create our container width slider control
	 * @deprecated 1.3.47
	 */
	class Starck_Customize_Width_Slider_Control extends WP_Customize_Control {
		public function render_content() {}
	}
}

if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'StarckLabelControl' ) ) {
	/**
	 * Heading area
	 * @since 0.1
	 * @depreceted 1.3.41
	 **/
	class StarckLabelControl extends WP_Customize_Control {
		public function render_content() {}
	}
}

if ( ! class_exists( 'Starck_Google_Font_Dropdown_Custom_Control' ) ) {
	/**
	 * A class to create a dropdown for all google fonts
	 */
	class Starck_Google_Font_Dropdown_Custom_Control extends WP_Customize_Control {
		public $type = 'gp-customizer-fonts';

		public function enqueue() {
			wp_enqueue_script( 'starck-customizer-fonts', trailingslashit( get_template_directory_uri() ) . 'inc/controls/js/typography-customizer.js', array( 'customize-controls' ), Starck_VERSION, true );
			wp_localize_script( 'starck-customizer-fonts', 'gp_customize', array( 'nonce' => wp_create_nonce( 'gp_customize_nonce' ) ) );
		}

		public function to_json() {
			parent::to_json();

			$number_of_fonts = apply_filters( 'Starck_number_of_fonts', 200 );
			$this->json['link'] = $this->get_link();
			$this->json['value'] = $this->value();
			$this->json['default_fonts_title'] = __( 'Default fonts', 'starck' );
			$this->json['google_fonts_title'] = __( 'Google fonts', 'starck' );
			$this->json['description'] = __( 'Font family','starck' );
			$this->json['google_fonts'] = apply_filters( 'Starck_typography_customize_list', Starck_get_all_google_fonts( $number_of_fonts ) );
			$this->json['default_fonts'] = Starck_typography_default_fonts();
		}
...
if ( ! class_exists( 'Starck_Select_Control' ) ) {
	/**
	 * A class to create a dropdown for font weight
	 */
	class Starck_Select_Control extends WP_Customize_Control {
...
if ( ! class_exists( 'Starck_Hidden_Input_Control' ) ) {
	/**
	 *	Create our hidden input control
	 */
	class Starck_Hidden_Input_Control extends WP_Customize_Control {
		// Setup control type
...
if ( ! class_exists( 'Starck_Font_Weight_Custom_Control' ) ) {
	/**
	 * A class to create a dropdown for font weight
	 * @deprecated since 1.3.40
	 */
	class Starck_Font_Weight_Custom_Control extends WP_Customize_Control {
...
if ( ! class_exists( 'Starck_Text_Transform_Custom_Control' ) ) {
	/**
	 * A class to create a dropdown for text-transform
	 * @deprecated since 1.3.40
	 */
	class Starck_Text_Transform_Custom_Control extends WP_Customize_Control {
...
if ( ! class_exists( 'Starck_Customize_Slider_Control' ) ) {
	/**
	 * Create our container width slider control
	 * @deprecated 1.3.47
	 */
	class Starck_Customize_Slider_Control extends WP_Customize_Control {
		public function render_content() {}
	}
}
