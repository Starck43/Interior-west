...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Starck_Typography_Customize_Control' ) ) {
	/**
	 * Create the typography elements control.
	 *
	 * @since 2.0
	 */
	class Starck_Typography_Customize_Control extends WP_Customize_Control {
		public $type = 'gp-customizer-typography';

		public function enqueue() {
			wp_enqueue_script( 'starck-typography-selectWoo', trailingslashit( get_template_directory_uri() ) . 'inc/controls/js/selectWoo.min.js', array( 'customize-controls', 'jquery' ), Starck_VERSION, true );
			wp_enqueue_style( 'starck-typography-selectWoo', trailingslashit( get_template_directory_uri() ) . 'inc/controls/css/selectWoo.min.css', array(), Starck_VERSION );

			wp_enqueue_script( 'starck-typography-customizer', trailingslashit( get_template_directory_uri() ) . 'inc/controls/js/typography-customizer.js', array( 'customize-controls', 'starck-typography-selectWoo' ), Starck_VERSION, true );
			wp_enqueue_style( 'starck-typography-customizer', trailingslashit( get_template_directory_uri() ) . 'inc/controls/css/typography-customizer.css', array(), Starck_VERSION );
		}
		...
		public function to_json() {
			...
			$this->json['default_fonts_title'] = __( 'System fonts', 'starck' );
			...
			$this->json['family_title'] = esc_html__( 'Font family', 'starck' );
			$this->json['weight_title'] = esc_html__( 'Font weight', 'starck' );
			$this->json['transform_title'] = esc_html__( 'Text transform', 'starck' );
			$this->json['category_title'] = '';
			$this->json['variant_title'] = esc_html__( 'Variants', 'starck' );
		...
		public function content_template() {
			...
			<# if ( 'undefined' !== typeof ( data.family ) ) { #>
				<div class="starcktheme-font-family">
					<label>
			...
			<# if ( 'undefined' !== typeof ( data.variant ) ) { #>
				...
				#>
				<div id={{{ data.variant.id }}}" class="starcktheme-font-variant" data-saved-value="{{ data.variant.value }}">
					<label>
			...
			<# if ( 'undefined' !== typeof ( data.category ) ) { #>
				<div class="starcktheme-font-category">
					<label>
			...
			<# if ( 'undefined' !== typeof ( data.weight ) ) { #>
				<div class="starcktheme-font-weight">
					<label>
			...
			<# if ( 'undefined' !== typeof ( data.transform ) ) { #>
				<div class="starcktheme-font-transform">
					<label>
