...
if ( ! function_exists( 'starck_get_color_defaults' ) ) {
	/**
	 * Set default options
	 */
	function starck_get_color_defaults() {
		return apply_filters( 'starck_color_option_defaults',
			array(
...
if ( ! function_exists( 'starck_get_default_fonts' ) ) {
	/**
	 * Set default options.
	 *
	 * @since 0.1
	 ...
	 */
	function starck_get_default_fonts( $filter = true ) {
		$defaults = array(
		...
		if ( $filter ) {
			return apply_filters( 'starck_font_option_defaults', $defaults );
		}
...
if ( ! function_exists( 'starck_spacing_get_defaults' ) ) {
	/**
	 ...
	 * @return array Option defaults.
	 */
	function starck_spacing_get_defaults( $filter = true ) {
		$defaults = array(
			'top_bar_top' => '10',
			'top_bar_right' => '10',
			'top_bar_bottom' => '10',
		...
		if ( $filter ) {
			return apply_filters( 'starck_spacing_option_defaults', $defaults );
		}
...
if ( ! function_exists( 'starck_typography_default_fonts' ) ) {
	/**
	 * Set the default system fonts.
	 *
	 * @since 1.3.40
	 */
	function starck_typography_default_fonts() {
		$fonts = array(
			'inherit',
			'System Stack',
		...
		return apply_filters( 'starck_typography_default_fonts', $fonts );
	}
}
